  ...
  return (
    <div className="min-h-screen bg-[#030712] text-gray-100 pt-28 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 text-xs font-mono text-gray-400 hover:text-[#06b6d4] transition-colors mb-8"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="p-6 rounded-2xl bg-surface/80 border border-white/10 relative overflow-hidden">
            <div className="text-3xl font-mono font-bold text-[#06b6d4]/40 mb-3">01</div>
            <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-[#06b6d4]" />
              Sign in with GitHub
            </h3>
            <p className="text-xs text-gray-400 leading-relaxed">
              Open <Link href="/admin" className="text-[#06b6d4] underline">o11y.works/admin</Link> and click 1-click GitHub login. No credentials or DB tokens needed.
            </p>
          </div>

          <div className="p-6 rounded-2xl bg-surface/80 border border-white/10 relative overflow-hidden">
            <div className="text-3xl font-mono font-bold text-[#06b6d4]/40 mb-3">02</div>
            <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              <PenSquare className="w-5 h-5 text-[#06b6d4]" />
              Write in Visual CMS
            </h3>
            <p className="text-xs text-gray-400 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-surface/80 border border-white/10 relative overflow-hidden">
            <div className="text-3xl font-mono font-bold text-[#06b6d4]/40 mb-3">03</div>
            <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              <GitPullRequest className="w-5 h-5 text-[#06b6d4]" />
              1-Click Publish
            </h3>
            <p className="text-xs text-gray-400 leading-relaxed">
        ...
        <div className="p-8 rounded-3xl bg-surface/90 border border-white/10 mb-12 shadow-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 font-mono text-xs">
            <div className="p-4 rounded-xl bg-[#030712] border border-white/10 flex items-center gap-3">
        ...
        <div className="text-center pt-8 border-t border-white/10">
          <Link
            href="/admin"
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-[#06b6d4] text-[#030712] font-mono font-bold text-sm hover:bg-[#06b6d4]/90 transition-colors shadow-lg"
          >
