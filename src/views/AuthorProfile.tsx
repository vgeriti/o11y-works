...
export const AuthorProfile: React.FC = () => {
  ...
  const username = (params?.username as string) || 'vgeriti';
  const author = getAuthorById(username);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="p-6 sm:p-10 rounded-3xl bg-surface/90 border border-white/10 backdrop-blur-md shadow-2xl mb-14">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            {/* GitHub Avatar Image */}
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden border-2 border-[#06b6d4]/40 bg-surface shadow-xl shrink-0">
              <img
                src={avatarUrl}
                alt={author.name}
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Github className="w-4 h-4 text-[#06b6d4]" /> GitHub
                  </a>
                  {author.linkedinUrl && (
                    <a
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-white/10 text-xs font-mono text-gray-400">
                  ...
                  <span className="text-[#06b6d4] font-semibold group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                    Read →
                  </span>
                </div>
              </div>
