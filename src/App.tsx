      ...
      return (
        <div className="min-h-screen bg-[#030712] text-gray-100 flex items-center justify-center p-6 font-mono">
          <div className="max-w-md w-full p-8 rounded-2xl bg-surface/90 border border-white/10 text-center shadow-2xl">
            ...
            <h2 className="text-xl font-bold text-white mb-2">Keystatic Admin Studio</h2>
            <p className="text-xs text-gray-400 leading-relaxed mb-6">
              {this.state.error?.message || 'Keystatic Admin initialized. Reload to authenticate with GitHub.'}
            </p>
            <button
            ...
            >
              <RefreshCw className="w-4 h-4" /> Reload Keystatic Studio
            </button>
          </div>
        </div>
      );
